package com.abbott.mosaic.build.ksp
...
class MosaicSymbolProcessor(
  ...
  override fun process(resolver: Resolver): List<KSAnnotated> {
    ...
    val tile = resolver.getClassDeclarationByName("com.abbott.mosaic.Tile") ?: return emptyList()
    ...
    val fqcn = "com.abbott.mosaic.generated.LibraryTileRegistry"
    ...
    if (decl != null) {
      registerFun.addStatement(
        ...
        ClassName("com.abbott.mosaic.generated", "LibraryTileRegistry")
      )
    }
