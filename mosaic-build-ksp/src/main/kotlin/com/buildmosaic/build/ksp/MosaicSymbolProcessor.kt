package com.buildmosaic.build.ksp
...
class MosaicSymbolProcessor(
  ...
  override fun process(resolver: Resolver): List<KSAnnotated> {
    ...
    val tile = resolver.getClassDeclarationByName("com.buildmosaic.core.Tile") ?: return emptyList()
    ...
    val registryClass = ClassName("com.buildmosaic.core", "MosaicRegistry")
    ...
    val fqcn = "com.buildmosaic.core.generated.LibraryTileRegistry"
    ...
    if (decl != null) {
      registerFun.addStatement(
        ...
        ClassName("com.buildmosaic.core.generated", "LibraryTileRegistry")
      )
    }

    val fileSpec = FileSpec.builder(
      "com.buildmosaic.core.generated",
